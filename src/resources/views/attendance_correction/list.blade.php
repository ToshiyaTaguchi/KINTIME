...
@section('css')
<link rel="stylesheet" href="{{ asset('css/attendance_correction/list.css') }}">
@endsection

@section('link')
<nav class="header-nav">
    <ul class="header-nav__list">
        <li class="header-nav__item"><a href="#" class="header-nav__link">勤怠</a></li>
        <li class="header-nav__item"><a href="{{ route('attendance.list') }}"
                class="header-nav__link header-nav__link">勤怠一覧</a></li>
        <li class="header-nav__item"><a href="{{ route('attendance_correction.list') }}"
                class="header-nav__link header-nav__link--active">申請</a></li>
    ...
    <section class="application-list__section">
        <table class="application-list__table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="application-list__detail-link"
                            href="{{ route('attendance.detail', $correction->attendance_id) }}">
                            詳細
                        </a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="application-list__empty">
                        承認待ちの申請はありません
                    </td>
                </tr>
                @endforelse
